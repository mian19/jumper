...
class ReaderViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if type == 0 {
            tView.text = """
Privacy Policy
This Privacy Policy applies to the Zahib Irshad developer (collectively “Company”, “we,” “us” or “our”) and describes how we handle and protect your personal data when you use our services (“Services”) and the choices available to you.
...
Contact Us
If you have any questions about these Terms or the Services, please contact us at tariqmehmod1@hotmail.com
